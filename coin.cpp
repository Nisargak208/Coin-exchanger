...
int minCoins4(int JPY[], int m4, int amount)
{
	// table[i] will be storing the minimum number of coins
	// required for i value. So table[n] will have result
	int table[amount+1];
...
int minCoins3(int FRANC[],int m3,int amount)
{
	int table[amount+1];
	table[0]=0;
	for(int i=1;i<=amount;i++)
...
int main()
{
    ...
    int m3=sizeof(FRANC)/sizeof(FRANC[0]);
    int m4=sizeof(JPY)/sizeof(JPY[0]);
    cout<<"\n"<<endl;
    cout<<"\n\t\t\t\t\t\t\t\tCOIN EXCHANGER"<<endl;
    cout<<"DENOMINATIONS OF INDIAN CURRENCY:"<<endl;
    cout<<"1, 2, 5, 10, 20, 50, 100, 200, 500, 2000\n"<<endl;
    cout<<"DENOMINATIONS OF US CURRENCY:"<<endl;
    cout<<"1, 2, 5, 10, 20, 50, 100\n"<<endl;
    cout<<"DENOMINATIONS OF FRANCE CURRENCY:"<<endl;
    cout<<"1,2, 5, 10, 20, 50, 100, 200,500\n"<<endl;
    cout<<"DENOMINATIONS OF JAPANESE CURRENCY:"<<endl;
